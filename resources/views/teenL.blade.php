...
<html lang="en">
    <head>
        ...
        <title>English for Teenagers</title>
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto text-dark">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <li class="nav-item">
                          <button class="btn btn-outline-primary px-4 ms-3" type="submit">Login</button>
      ...
      <section id="utama">
            <div class="carousel-inner" >
                <div class="carousel-item active c-item" style="height: 50vh;">
                    <img src="./img/gET.jpg" class="d-block w-100 c-img" alt="Slide 1">
                    <div class="overlay"></div>
                    <div class="carousel-caption top-0 mt-5 text-center d-flex flex-column align-items-center justify-content-center pt-5" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out" style="margin-top: 20rem;">
                      <h2 class="text-uppercase mb-3 fs-1 mt-5">English for Teenagers (ET)</h2>
                      <div class="row text-center d-flex flex-column align-items-center justify-content-center">
                          <div class="col-lg-8 col-md-10">
                              <p class="lead text-capitalize mb-4 fs-6">
                                The junior high school English program enhances students' confidence, improves speaking, listening, reading, and writing skills, and introduces cultural diversity.
                              </p>
      ...
      <!-- Start Description -->
        <section id="desc">
            <div class="container">
                <div class="row-cols-1 m-5"  data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out">
                    <p class="fw-bold fs-5">
                        Deskripsi 
                          <ul>  
                              <li>Program yang dirancang untuk membekali siswa SMP </li>
                              <li>Dirancang untuk meningkatkan kepercayaan diri dalam menggunakan bahasa Inggris sehari-hari </li>
                              <li>Mendukung mata pelajaran bahasa Inggris di sekolah.</li>
                          </ul>
                      </p> 
                    <p class="fw-bold fs-5 mt-5">
                        Keunggulan Program  
                          <ul>  
                              <li>Meningkatkan kemampuan berbicara, mendengar, membaca dan menulis peserta.</li>
                              <li>Memperluas kosakata dan meningkatkan kemampuan tata bahasa peserta secara sistematis.</li>
                              <li>Membangun rasa percaya diri peserta dalam berbahasa Inggris.</li>
                              <li>Memperkenalkan peserta kepada tradisi dan budaya dari Indonesia dan dari negara lain.</li>
                          </ul>
                      </p> 
                      ...
                      <p class="fw-bold fs-5 mt-5 ">
                        Level dan periode belajar 
                            <ul >  
                               <li>12 tingkat 
                                    <ul>
                                      <li>Elementary 1 – 4</li>
                                      <li>Pre Intermediate 1 - 4</li>
                                      <li>Intermediate 1 - 4</li>
                                    </ul>
                               </li>
                               <li>2.5 bulan (22 sesi)</li>
                               <li>1,5 jam per sesi, 2 sesi per minggu.</li>
                            </ul>
                        </p> 
...
<section class="">
 ...
 <div class="row">
   ...
   <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
     ...
     <p>
       <a class="text-white link-offset-2 link-offset-3-hover link-underline-light link-underline-opacity-0 link-underline-opacity-75-hover" href="/youthL">English For Young Learner</a>
     </p>
     <p>
       <a class="text-white link-offset-2 link-offset-3-hover link-underline-light link-underline-opacity-0 link-underline-opacity-75-hover" href="/teenL">English For Teens </a>
     </p>
     <p>
       <a class="text-white link-offset-2 link-offset-3-hover link-underline-light link-underline-opacity-0 link-underline-opacity-75-hover" href="/adultL">English For Adults</a>
     </p>
