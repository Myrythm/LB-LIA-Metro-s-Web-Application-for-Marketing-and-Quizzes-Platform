...
<html lang="en">
    <head>
        ...
        <title>Conversation for Business</title>
      ...
      <section id="utama">
            <div class="carousel-inner" >
                <div class="carousel-item active c-item" style="height: 50vh;">
                    <img src="./img/cEmployee.jpg" class="d-block w-100 c-img" alt="Slide 1">
                    ...
                    <div class="carousel-caption top-0 mt-5 text-center d-flex flex-column align-items-center justify-content-center pt-5" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out" style="margin-top: 20rem;">
                      <h2 class="text-uppercase mb-3 fs-1 mt-5">Conversation for Business</h2>
                      <div class="row text-center d-flex flex-column align-items-center justify-content-center">
                          <div class="col-lg-8 col-md-10">
                              <p class="lead text-capitalize mb-4 fs-6">
                                The Conversation For Business program is designed to improve business communication skills through interactive exercises, form effective communication strategies, and support professional success.
                              </p>
            ...
            <div class="container">
                <div class="row-cols-1 m-5"  data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out">
                    <p class="fw-bold fs-5">
                        Deskripsi dan Keunggulan Program
                          <ul>  
                              <li>Untuk para Mahasiswa (terutama semester akhir), Karyawan, ataupun mereka yang ingin meningkatkan keterampilan berbicara mereka dalam Bahasa Inggris. </li>
                              <li>Membantu para pesertanya menggunakan strategi dan teknik percakapan yang efektif untuk berkomunikasi, baik  dalam lingkungan kerja/bisnis maupun dalam konteks keseharian.</li>
                              <li>Mempelajari berbagai kosakata dan ekspresi yang berkaitan erat dalam dunia kerja, sehingga mereka akan siap saat berhadapan dengan rekan kerja atau mitra kerja yang berasal dari luar</li>
                              <li>Membantu para pesertanya menjadi lebih baik dalam ketiga komponen Bahasa (kosakata, tata Bahasa dan pelafalan) sehingga mereka akan semakin percaya diri dalam berbicara.</li>
                          </ul>
                      </p> 
                      ...
                      <p class="fw-bold fs-5 mt-5 ">
                        Level dan periode belajar 
                            <ul >  
                               ...
                               <li>2 sesi per minggu; (90 menit per sesi).</li>
