...
<head>
    ...
    <title> Quiz Complete Sentence</title>
    <link rel="stylesheet" href="{{ asset('styleSentence.css') }}">
...
<body>
    ...
    <script src="{{ asset('js/quiz_sentence/questions.js') }}"></script>

    <!-- Inside this JavaScript file I've coded all Quiz Codes -->
    <script src="{{ asset('js/quiz_sentence/script.js') }}"></script>
